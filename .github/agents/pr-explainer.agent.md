---
name: Auditor Rigoroso de PR
description: Analisa as alterações estritamente pelo código fonte e, ao final, audita se a implementação real resolve o que foi descrito no PR/Issues.
