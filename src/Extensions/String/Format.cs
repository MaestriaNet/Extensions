...
public static partial class MaestriaExtensions
{
    ...
    /// <returns>
    ///     <para>A copy of <paramref name="value">format</paramref> in which the format items have been replaced by the string representation of the corresponding objects in <paramref name="args">args</paramref>.</para>
    ///     <para>If input is null value, returns is empty string.</para>
    /// </returns>
